...
--
-- Host: localhost:3360
-- Tempo de geração: 13-Jun-2022 às 17:13
...
INSERT INTO `produto` (`codigo_produto`, `descricao`, `preco_compra`, `preco_venda`, `estoque_minimo`, `quantidade_comprada`, `quantidade_vendida`) VALUES
(1, 'Abacate!', 3, 5, 20, 4, 2);
...
--
ALTER TABLE `produto`
  MODIFY `codigo_produto` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
